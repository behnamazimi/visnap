...
- **[HTML Report](/docs/configuration/reporters#html-reporter)**: Interactive visual comparisons with side-by-side views and highlighted differences
- **[JSON Report](/docs/configuration/reporters#json-reporter)**: Structured data perfect for CI/CD pipelines and automated decision-making
