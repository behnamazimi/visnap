...
- [Adapters Overview](/docs/concepts/adapters-overview) - Learn about browser and test source adapters
- [Comparison Engines](/docs/concepts/comparison-engines) - Understand how visual differences are detected
